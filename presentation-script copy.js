...
`;
  ...
  dataContainer.style.marginLeft = '300px'; // Przesunięcie danych w prawo
  dataContainer.innerHTML = `
    <p style="font-size: 1.2em; margin-bottom: 20px; text-align: left;">
      <span style="font-weight: bold;">Liczba dokumentów:</span> 461
    </p>
    <p style="font-size: 1.2em; margin-bottom: 20px; text-align: left;">
      <span style="font-weight: bold;">10 pierwszych słów kluczowych:</span>
    </p>
    <ul style="font-size: 1.1em; line-height: 1.8em; padding-left: 40px; margin: 0; list-style-type: disc;">
  ...
  qualitativeHeader.style.marginBottom = '150px'; // Odstęp poniżej nagłówka
  qualitativeAnalysisSlide.appendChild(qualitativeHeader);

  // Kontener dla listy punktów
  const pointsContainer = document.createElement('div');
  pointsContainer.style.width = '60%'; // Szerokość kontenera dla punktów
  ...
  examplesContainer1.style.fontSize = '1.3em';
  examplesContainer1.style.lineHeight = '1.4em';
  examplesContainer1.style.margin = '150px auto'; // Obniżenie kontenera
  ...
  examplesContainer2.style.fontSize = '1.3em';
  examplesContainer2.style.lineHeight = '1.4em';
  ...
  conclusionsContainer.style.fontSize = '1.3em';
  conclusionsContainer.style.lineHeight = '1.6em';
  ...
  conclusionsContent1.style.fontSize = '1.3em';
  conclusionsContent1.style.lineHeight = '1.6em';
  ...
  conclusionsContent2.style.fontSize = '1.3em';
  conclusionsContent2.style.lineHeight = '1.6em';
