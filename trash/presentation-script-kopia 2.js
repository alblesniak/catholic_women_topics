document.addEventListener('DOMContentLoaded', async () => {
  ...
  // 1. Statystyki forów
  {
    ...
    forumSection.style.flexDirection = 'column';
    forumSection.style.alignItems = 'center';
    forumSection.style.justifyContent = 'flex-start';
    forumSection.style.height = '100%';

    const h = document.createElement('h1');
    h.textContent = 'Statystyki forów';
    forumSection.appendChild(h);
    ...
    columnsContainer.style.gap = '200px'; // zwiększony odstęp między kolumnami
    columnsContainer.style.marginTop = '100px';
    ...
    leftTitle.textContent = 'Forum Radio Katolik';
    leftTitle.style.textAlign = 'center';
    leftTitle.style.fontSize = '1.2em';
    leftColumn.appendChild(leftTitle);

    const leftImg = document.createElement('img');
    leftImg.src = './images/radio_katolik.png';
    leftImg.style.maxWidth = '600px'; // jeszcze większy obraz
    leftImg.style.height = 'auto';
    leftImg.style.display = 'block';
    leftImg.style.margin = '20px 0';
    leftColumn.appendChild(leftImg);

    const leftLink = document.createElement('p');
    leftLink.textContent = 'https://www.dyskusje.radiokatolik.pl/';
    leftLink.style.textAlign = 'center';
    leftColumn.appendChild(leftLink);
    ...
    rightTitle.textContent = 'Forum Dolina Modlitwy';
    rightTitle.style.textAlign = 'center';
    rightTitle.style.fontSize = '1.2em';
    rightColumn.appendChild(rightTitle);

    const rightImg = document.createElement('img');
    rightImg.src = './images/dolina_modlitwy.png';
    rightImg.style.maxWidth = '600px'; // jeszcze większy obraz
    rightImg.style.height = 'auto';
    rightImg.style.display = 'block';
    rightImg.style.margin = '20px 0';
    rightColumn.appendChild(rightImg);

    const rightLink = document.createElement('p');
    rightLink.textContent = 'https://dolinamodlitwy.pl/forum/';
    rightLink.style.textAlign = 'center';
    rightColumn.appendChild(rightLink);

    columnsContainer.appendChild(leftColumn);
    columnsContainer.appendChild(rightColumn);
    forumSection.appendChild(columnsContainer);
    ...
    forumSection.appendChild(tableContainer);
  ...
  // 2. Statystyki unikalnych użytkowników
  {
    ...
    // Rozkładamy elementy w pionie z odstępami między nimi
    // Pierwszy element (h1) będzie u góry, ostatni (summary) na dole
    // a element środkowy zajmie miejsce pośrodku
    usersSection.style.justifyContent = 'space-between';
    usersSection.style.alignItems = 'center';

    const h = document.createElement('h1');
    h.textContent = 'Statystyki unikalnych użytkowników na forach';
    // Nagłówek ląduje u góry slajdu (dzięki space-between)
    usersSection.appendChild(h);

    // Kontener na tabelkę
    const middleContainer = document.createElement('div');
    // Rozciągamy kontener, aby zajął pozostałą przestrzeń między h1 a podpisem
    ...
    // Dzięki temu tabelka znajdzie się dokładnie w środku dostępnej przestrzeni
    ...
    // Dodajemy middleContainer z tabelą do usersSection
    usersSection.appendChild(middleContainer);

    // Podpis na dole slajdu
    const summary = document.createElement('p');
    summary.textContent = 'Suma wszystkich unikalnych użytkowników: 4566';
    summary.style.textAlign = 'center';
    // Podpis znajduje się w ostatnim elemencie flex-containera z justify-content: space-between
    // dzięki czemu wyląduje na dole slajdu
  ...
  // 3. Top 10 użytkowników na forach (Radio Katolik i Dolina Modlitwy)
  {
    ...
    columnsContainer.style.justifyContent = 'center';
    columnsContainer.style.alignItems = 'flex-start';
    columnsContainer.style.gap = '300px';
    columnsContainer.style.marginTop = '200px';
    columnsContainer.style.marginBottom = '0px';
    ...
    leftColumn.style.flexDirection = 'column';
    leftColumn.style.alignItems = 'center';
    leftColumn.style.width = '100%'; // tabela będzie maksymalnie szeroka
    ...
    leftTable.style.width = '100%'; // tabela będzie maksymalnie szeroka
    ...
    rightColumn.style.flexDirection = 'column';
    rightColumn.style.alignItems = 'center';
    rightColumn.style.width = '100%'; // tabela będzie maksymalnie szeroka
    ...
    rightTable.style.width = '100%'; // tabela będzie maksymalnie szeroka
