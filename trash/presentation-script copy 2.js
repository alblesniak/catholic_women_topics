document.addEventListener('DOMContentLoaded', async () => {
  // Kod generujący wcześniejsze slajdy
  // ---------------------------------------------------------
  ...
  // Definicja slajdów (HTML w formie stringów) z wcześniejszych danych
  const introSlide = `
    <section>
  ...
  const forumStatsSlides = `
    <section>
        ...
        <section>
            ...
            <p><strong>Suma wszystkich postów:</strong> ${
              forumStats.sumPosts
            }</p>
        </section>
        <section>
  ...
  // ---------------------------------------------------------
  // KONIEC wcześniejszych slajdów
  // ---------------------------------------------------------

  // Teraz kontynuujemy z bieżącym kodem
  const slidesContainer = document.getElementById('category-slides');

  // Umieszczamy wcześniejsze slajdy na samym początku prezentacji
  ...
  async function loadWordclouds() {
    // Kod ładujący chmury słów (bez zmian)
