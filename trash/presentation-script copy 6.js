document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Modyfikacja wprowadzająca żądane zmiany w pierwszym slajdzie
  const introSlide = `
    <section>
      <h1 class="main-category">Statystyki korpusów</h1>
      <div style="display: flex; justify-content: center; align-items: flex-start; gap: 100px; margin-top: 40px;">
        <div style="display: flex; flex-direction: column; align-items: center;">
          <h2>Forum Radio Katolik</h2>
          <img src="./images/radio_katolik.png" style="max-height: 42vh; width: auto; object-fit: contain;" />
          <a href="https://www.dyskusje.radiokatolik.pl/" target="_blank">https://www.dyskusje.radiokatolik.pl/</a>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center;">
          <h2>Forum Dolina Modlitwy</h2>
          <img src="./images/dolina_modlitwy.png" style="max-height: 42vh; width: auto; object-fit: contain;" />
          <a href="https://dolinamodlitwy.pl/forum/" target="_blank">https://dolinamodlitwy.pl/forum/</a>
        </div>
      </div>
    </section>
  `;
  ...
  function createSubcategoryChart(category, colorTheme) {
    ...
    category.subcategories.forEach((subcategory, subIndex) => {
      if (subcategory.subsubcategories) {
        // Poprawka: używamy 'subcategory' zamiast 'subsubcategory'
